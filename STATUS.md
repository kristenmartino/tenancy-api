...
1. **[#2]** Record 60-90s demo video for the case study (`effort-day`) — final V0 item. Backend + frontend feature-complete; bbox overlay production-verified.
2. **Demo-prep polish** (`effort-day`) — mobile layout below 900px, empty / loading / error states consistent across the demo path, confidence-chip tooltip.
